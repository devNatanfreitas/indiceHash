        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{tableData.total_tuplas.toLocaleString()}</div>
            ...
            {statistics && (
              <>
                ...
                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  <div className="text-2xl font-bold text-orange-600">{statistics.fator_carga.toFixed(2)}</div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 border rounded-lg text-center">
                ...
                <div className="text-xs text-gray-600">{statistics.taxa_colisoes <= 0.1 ? "Baixa" : "Alta"}</div>
              </div>
              ...
              <div className="p-4 border rounded-lg text-center">
                ...
                <div className="text-xs text-gray-600">{statistics.taxa_overflows <= 0.05 ? "Baixo" : "Alto"}</div>
              </div>
              ...
              <div className="p-4 border rounded-lg text-center">
                ...
                <div className="text-xs text-gray-600">{statistics.fator_carga <= 0.8 ? "Adequada" : "Alta"}</div>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-700">
                  O índice hash reduziu o custo de busca em <strong>{efficiency.improvement}%</strong> comparado ao
